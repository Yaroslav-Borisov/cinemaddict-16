...
import { StatisticsFilterType } from '../utils/consts.js'
import { genresToCountMap, getTopGenre, watchedFilmCountToUserRank } from '../utils/utils.js'
  ...
  return `<section class="statistic">
    ...
    <ul class="statistic__text-list">
      ...
      <li class="statistic__text-item">
        ...
        <p class="statistic__item-text">${Math.trunc(watchedFilmsDuration / 60) || 0} <span class="statistic__item-description">h</span> ${watchedFilmsDuration - Math.trunc((watchedFilmsDuration / 60 )) * 60 || 0} <span class="statistic__item-description">m</span></p>
      </li>
      <li class="statistic__text-item">
...
export default class SiteStatsView extends SmartView {
  #films = null
  #chart = null
  ...
  #parseWatchedFilmsToData = (watchedFilms) => {
    ...
    const watchedFilmsDuration = watchedFilms.reduce((currentDuration, currentFilm) => {
      return currentDuration + parseInt(currentFilm.duration)
    }, 0)
